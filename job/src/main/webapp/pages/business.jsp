      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container" id="">
          <%-- <a class="navbar-brand" href="/"><h2 style="font-size: 56px;">DR4BIZ</h2>
            <p style="color: aliceblue; font-style: italic;">A Doctor for managing the health of your Business busi</p></a> --%>
            <img class="mywallet_logo" src="static/css/images/mywallet.jpg">
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto" style="background-color: black">
              <li class="nav-item active">
                <a class="nav-link" href="/" ><p style="color: aliceblue;">Home</p>
                  <span class="sr-only"></span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#why"> <p style="color: aliceblue;"> Why Us</p></a>
              </li>
              <li class="nav-item">
                  <div class="dropdown" >
               <a class="nav-link" href="#services"><p style="color: aliceblue;">Our Services &#9660;</p> </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#experts"><p style="color: aliceblue;">Experts</p></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#test"><p style="color: aliceblue;">Testimonials</p></a>
              </li>
              <li class="nav-item">
        ...
        <div class="row">
          ...
          <a name="whyphone"></a>
            <span>
              ...
              <br>
              <p style="color: aliceblue; font-size: large; text-align: center; ">All business require support and resources</p>
              <br> 
              <p style="color: aliceblue; font-size: large; text-align: center; ">Small & medium sized businesses also want sharp minds with strong business acumen to work on their business problems but they either don't have the size to engage them permanently or they don't have the money to afford them.</p>
              <br> 
              <p style="color: aliceblue; font-size: large; text-align: center; ">They also want mentors whom they can <b style="color: black;">Consult as and when required</b> to solve their business problems or take a better business decision but sometimes they can't afford high fees of business consultants and sometimes they don't want to risk their money with consultants who rather than helping them solve their <b style="color: black;">specific business problem</b>, give gyan.</p>
              <br>
              <p style="color: aliceblue; font-size: large; text-align: center; ">To run a business smoothly & profitably, a company should not only have robust support function teams but also ensure that the cost of the support function team is a small fraction of the total cost. Unfortunately, in tough business environment and smaller business sizes, companies are forced to compromise on support functions to manage their cost within the budgets.</p>
              <br>
              <p style="color: black; font-size: large; text-align: center;  "><b><u>"DR4BIZ has been incorporated with an objective to solve these problems faced by small & medium businesses by providing them these services in a Result oriented manner but at a very low & variable cost."</u></b></p>
                <br>
