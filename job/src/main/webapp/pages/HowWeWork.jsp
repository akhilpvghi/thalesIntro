    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container" id="">
            <a class="navbar-brand" href="/"><h2 style="font-size: 56px;">DR4BIZ</h2>
                <p style="color: aliceblue; font-style: italic;">A Doctor for managing the health of your Business akkk</p></a>
    ...
    <div class="container" id="work">
        <div class="row" style="justify-content: center">
            ...
            <span>
              ...
              <br>
              <img src="static/css/assets/images/flowchart.jpg" alt="work">
