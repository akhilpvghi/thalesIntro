...
<div class="margin" style="height: 100vh">
<div class="content">
    ...
    <strong style="font-weight: 500;letter-spacing: 0.288rem;font-size: 22px">&#8377 ${users.getBalance()}</strong>
    </div>
    <div style="align-items: center; display: flex;justify-content: center; margin-top: 2%">
    <a href="payment"><button id="button" style="align-content: center">Add Money</button></a><
        <a href="sendMoney"><button id="button" style="align-content: center">Send Money</button></a>
           <a href="walletStmt"><button id="button" style="align-content: center">Passbook</button></a>
                <a href="bill"><button id="button" style="align-content: center">E-bill</button></a>

    </div>
    <br>
    <hr>
</div>
<%--<h2 style="text-align: center; margin-top: 2%"><u>TRANSACTION HISTORY</u></h2>--%>
<%--<br>--%>
<%--&lt;%&ndash;<div class="tbl-header">--%>
<%--    <table style="width:100%"  >--%>

<%--    </table>--%>
<%--</div>&ndash;%&gt;--%>

<%--<div class="tbl-content" style="overflow-x: auto;table-layout: unset">--%>
<%--    <table>--%>
<%--        <thead>--%>
<%--        <tr>--%>
...
<%--                <td>${i.getTrans_Id()}</td>--%>
<%--                <td>${i.getDate()}</td>--%>
<%--                <td>${i.getParticular()}</td>--%>
<%--                <td style="color: green">+${i.getCredit_Amount()}</td>--%>
<%--                <td style="color: red">-${i.getDebit_Amount()}</td>--%>
<%--                <td>${i.getTemp_Balance()}</td>--%>
<%--            </tr>--%>
<%--        </c:forEach>--%>
<%--    </table>--%>
<%--</div>--%>
