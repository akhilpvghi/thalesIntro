...
<div class="margin">
    ...
    <div class="flex">
    <div class="loginBox">
    <h1 style="text-align: center;color: #FFFFFF">MY PROFILE</h1>
<div id="User Info">
    <form action="updateuserdetail" method="post" >
        ...
        <br>
        <label for="lname">Referred Coupon</label>
    ...
    <div class="loginBox" id="second">
    <h1 style="text-align: center;color: #FFFFFF">My Billing Details</h1>
    <div id="Billing Info">
    <form action="updatebillingdetail" method="post">
